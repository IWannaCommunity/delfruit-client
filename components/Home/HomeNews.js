...
function HomeNews() {
	return (
		<nav className="bg-black bg-news-bg flex h-[22rem] justify-center items-center space-x-10">
			...
			<div className="flex flex-col justify-center items-center w-4/12 h-52">
				<div className="bg-[#232123] hover:bg-[#D63636] flex text-white font-bold text-lg px-5 rounded-t-lg w-full p-2 h-14">
				...
				<div className="overflow-auto flex bg-white font-bold text-[#232123] rounded-b-lg p-5 h-52 max-h-52 w-full">
					<div className="flex-auto justify-start">
