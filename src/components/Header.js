			...
			<header className="flex justify-between items-center h-auto">
				...
				<div className="flex text-2xl mx-14 space-x-7 font-semibold items-center">
					...
					<svg width="12" height="30" viewBox="0 0 12 30" fill="none" xmlns="http://www.w3.org/2000/svg">
						<line x1="0.530154" y1="29.0198" x2="10.7908" y2="0.829007" stroke="#E4E4E4"/>
					</svg>
					...
					<div className="flex cursor-pointer">
						<svg className="hover:fill-[#F9F9F9]" width="18" height="12" viewBox="0 0 18 12" xmlns="http://www.w3.org/2000/svg" fill="#E4E4E4">
				...
				<div className="flex ml-10 space-x-10">
					...
					<button>
						<svg className="hover:fill-[#F9F9F9]"  width="32" height="22" viewBox="0 0 32 22" fill="#E4E4E4" xmlns="http://www.w3.org/2000/svg">
