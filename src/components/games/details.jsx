		...
		<nav className="text-[#232123] bg-[#F9F9F9]">
			<div className="relative flex-col mx-40 my-10">
				...
				<div className="mt-20 grid grid-cols-2">
					{carousel_photos && carousel_photos.length >= 1 ? (
						<Image
							id={DISPLAY_CURSCRNSHOT}
							className="mx-auto rounded-lg drop-shadow-[0_10px_8px_rgba(0,0,0,0.50)] w-[650px] h-[494px]"
							src={photos[0] ?? ""}
							width={650}
							height={494}
						/>
					) : (
						<div className="w-[650px] h-[494px]" />
					)}
