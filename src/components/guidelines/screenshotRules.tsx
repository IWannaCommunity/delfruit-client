export default function ScreenshotRules(): JSX.Element {
	return(
		<>
			<h3>Uploading Screenshots</h3>
			<ul>
				...
				<li>
					Do not upload a screenshot of glitches or bugs that the game might contain.
				</li>
			</ul>
		</>
	);
